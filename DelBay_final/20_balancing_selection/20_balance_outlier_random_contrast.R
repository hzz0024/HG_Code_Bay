...
format_outlier_output <- function(pop, j, outlier_list){
  ...
  #outlier_list = "18_HC_NB_shared_outlier.txt"
  dat_ = read.delim(outlier_list, header = TRUE, sep='\t')
  dat_$SNP = paste0(dat_$chr, "_", dat_$pos)
...
format_random_output <- function(pop, k, j, random_list_name){
  #pop="HC_18"
  #k=1
  #j=1
...
contrast <- function(pop, outlier, random_name){
  df_1=data.frame()
  for (j in seq(0,9)) {
    #pop="HC_18"
    #outlier="18_HC_NB_shared_outlier.txt"
    df_1 = rbind(df_1,format_outlier_output(pop, j, outlier))
  ...
  for (i in seq(1,100)) {
    ...
    for (j in seq(0,9)){
      ...
      df_2_ = format_random_output(pop, i, j, random_name)
      if(nrow(df_2_) != 0)
...
HC_18 <- contrast("HC_18","18_HC_NB_shared_outlier.txt","/Users/HG/Dropbox/Mac/Documents/HG/DelBay_final/15_local_LD/18_HC_NB/18_HC_NB_random_2295")
HC_18_observed_mean <- 27.6832074241455
HC_18_random_mean_point <- 26.1638513903762
HC_18_p <- 0
HC_19 <- contrast("HC_19","19_HC_NB_shared_outlier.txt","/Users/HG/Dropbox/Mac/Documents/HG/DelBay_final/15_local_LD/19_HC_NB/19_HC_NB_random_2147")
HC_19_observed_mean <- 26.6137645868232
HC_19_random_mean_point <- 25.2212946826696
HC_19_p <- 0
HC_21 <- contrast("HC_21","21_HC_NB_shared_outlier.txt","/Users/HG/Dropbox/Mac/Documents/HG/DelBay_final/15_local_LD/21_HC_NB/21_HC_NB_random_1893")
HC_21_observed_mean <- 25.0731960152676
HC_21_random_mean_point <- 23.5020763338657
HC_21_p <- 0
Sur_19 <- contrast("Sur_19","19_Sur_Ref_shared_outlier.txt","/Users/HG/Dropbox/Mac/Documents/HG/DelBay_final/15_local_LD/19_Sur_Ref/19_Sur_Ref_random_2250")
Sur_19_observed_mean <- 22.4191285306731
Sur_19_random_mean_point <- 20.9240972688639
Sur_19_p <- 0
Sur_20 <- contrast("Sur_20","20_Sur_Ref_shared_outlier.txt","/Users/HG/Dropbox/Mac/Documents/HG/DelBay_final/15_local_LD/20_Sur_Ref/20_Sur_Ref_random_2294")
Sur_20_observed_mean <- 25.4316682189045
Sur_20_random_mean_point <- 23.9055274815758
Sur_20_p <- 0

NB_18 <- contrast("NB_18","18_HC_NB_shared_outlier.txt","/Users/HG/Dropbox/Mac/Documents/HG/DelBay_final/15_local_LD/18_HC_NB/18_HC_NB_random_2295")
NB_18_observed_mean <- 21.7160483763952
NB_18_random_mean_point <- 21.8778282467807
NB_18_p <- 0.72
NB_19 <- contrast("NB_19","19_HC_NB_shared_outlier.txt","/Users/HG/Dropbox/Mac/Documents/HG/DelBay_final/15_local_LD/19_HC_NB/19_HC_NB_random_2147")
NB_19_observed_mean <- 24.9237815971219
NB_19_random_mean_point <- 25.4043325073074
NB_19_p <- 0.93
NB_21 <- contrast("NB_21","21_HC_NB_shared_outlier.txt","/Users/HG/Dropbox/Mac/Documents/HG/DelBay_final/15_local_LD/21_HC_NB/21_HC_NB_random_1893")
NB_21_observed_mean <- 
NB_21_random_mean_point <- 
NB_21_p <- 
Ref_19 <- contrast("Ref_19","19_Sur_Ref_shared_outlier.txt","/Users/HG/Dropbox/Mac/Documents/HG/DelBay_final/15_local_LD/19_Sur_Ref/19_Sur_Ref_random_2250")
Ref_19_observed_mean <- 
Ref_19_random_mean_point <- 
Ref_19_p <- 
Ref_20 <- contrast("Ref_20","20_Sur_Ref_shared_outlier.txt","/Users/HG/Dropbox/Mac/Documents/HG/DelBay_final/15_local_LD/20_Sur_Ref/20_Sur_Ref_random_2294")
Ref_20_observed_mean <- 
Ref_20_random_mean_point <- 
Ref_20_p <- 
