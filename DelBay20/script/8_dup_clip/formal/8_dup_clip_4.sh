...
BAMLIST=/workdir/hz269/DelBay20/sample_lists/bam_list_4.txt # Path to a list of merged, deduplicated, and overlap clipped bam files. Full paths should be included.
