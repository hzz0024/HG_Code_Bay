...
RAWFASTQDIR=/workdir/hz269/DelBay_test/raw_fastq/ # Path to raw fastq files. An example for the Greenland cod data is: /workdir/backup/cod/greenland_cod/fastq/
