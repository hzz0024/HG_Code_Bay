...
/programs/angsd_20180926/angsd/angsd -P $NB_CPU -doMaf 1 -dosaf 1 -GL 1 -doGlf 2 -doMajorMinor 1 -doCounts 1 -doDepth 1 -doIBS 1 -makeMatrix 1 -doCov 1 -maxDepth 1000 -dumpCounts 2 -anc $ANC -remove_bads 1 -minMapQ 30 -minQ 20 -minInd $MIN_IND -minMaf $MIN_MAF -setMaxDepth 962 -SNP_pval 1e-6 -b $WILD $REGIONS -out "/workdir/hz269/02_PCA_MDS/"$target"_maf"$MIN_MAF"_pctind"$PERCENT_IND"_cv30_noinvers"
