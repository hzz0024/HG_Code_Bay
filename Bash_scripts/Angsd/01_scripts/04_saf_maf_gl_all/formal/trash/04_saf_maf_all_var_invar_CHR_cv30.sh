...
angsd -P $NB_CPU -doMaf 1 -GL 1 -doGlf 2 -doMajorMinor 1 -doCounts 1 -doDepth 1 -maxDepth 1000 -dumpCounts 2 -anc $ANC -remove_bads 1 -minMapQ 30 -minQ 20 -minInd $MIN_IND -b $CHR -out "/scratch/hzz0024/DelBay19_HG/09_theta/"$target"_maf"$MIN_MAF"_pctind"$PERCENT_IND"_cv30_allsite"
