...
###################
# for whole SNPs
LOC_all <- read.table("genetyped_data_n_509_maf05_maxmiss095_popmiss095_hwe.bed.gene.txt", header = FALSE, sep = "\t", quote="", col.names = paste0("V",seq_len(6)), fill = TRUE)
...
system(paste("python3 extract_gene_V2.py -i Gene_annotation_all.txt -t pop_n_477_pcadapt_outflank.shared.10k.outlier.igv_Dom_Wild.sliding.zfst.outlier.merged.igv.outlier.merged.igv -o pop_n_477_pcadapt_outflank.shared.10k.outlier.igv_Dom_Wild.sliding.zfst.outlier.merged.igv.outlier.merged.igv.gene.txt"))
format_LOC("pop_n_477_pcadapt_outflank.shared.10k.outlier.igv_Dom_Wild.sliding.zfst.outlier.merged.igv.outlier.merged.igv.gene.txt")
...
# load gene ID
shared_SNP <- read.delim("pop_n_477_pcadapt_outflank.shared.10k.outlier.igv_Dom_Wild.sliding.zfst.outlier.merged.igv.outlier.merged.igv.gene.txt.unique.LOC.txt", header = F, sep='\t')$V1
