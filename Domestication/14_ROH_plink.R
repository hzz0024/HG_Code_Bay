...
setwd("~/Dropbox/Mac/Documents/HG/Domestication/14_ROH/All_n_509_formal_run/")
setwd("~/Dropbox/Mac/Documents/HG/Domestication/14_ROH/DOM_n_262_formal_run")
setwd("~/Dropbox/Mac/Documents/HG/Domestication/14_ROH/WILD_n_247_formal_run")
#===
