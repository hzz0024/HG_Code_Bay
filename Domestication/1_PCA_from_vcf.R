...
# Parameters as interpreted:
#   --vcf genetyped_data_all_samples.vcf
# --keep sample_id_subset_576_no_NYH.txt
# --recode-INFO-all
# --maf 0.01
# --max-missing 0.7
# --out genetyped_data_n_576_maf01_maxmiss07
# --recode
# 
# Keeping individuals in 'keep' list
# After filtering, kept 576 out of 842 Individuals
# Outputting VCF file...
# After filtering, kept 223699 out of a possible 300446 Sites
...
# Parameters as interpreted:
#   --vcf genetyped_data_all_samples.vcf
# --keep sample_id_subset_514_no_CBW.txt
# --recode-INFO-all
# --maf 0.01
# --max-missing 0.7
# --out genetyped_data_n_514_maf01_maxmiss07
# --recode
# 
# Keeping individuals in 'keep' list
# After filtering, kept 514 out of 842 Individuals
# Outputting VCF file...
# After filtering, kept 222245 out of a possible 300446 Sites
