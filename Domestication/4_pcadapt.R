...
path_to_file <- "./genetyped_data_n_514_maf01_maxmiss07_pruned.bed"
file <- read.pcadapt(path_to_file, type = "bed")
path_to_bim <- "./genetyped_data_n_514_maf01_maxmiss07_pruned.bim"
...
# pruned SNP set with 10K as the pruning window
path_to_file <- "./genetyped_data_n_514_maf01_maxmiss07.bed"
file <- read.pcadapt(path_to_file, type = "bed")
path_to_bim <- "./genetyped_data_n_514_maf01_maxmiss07.bim"
bim_file = read.delim(path_to_bim, header = FALSE, sep='\t')
# Scree plot
par(mfrow=c(1,1))
x <- pcadapt(input = file, K = 10)
...
# all
bedfile = "genetyped_data_n_514_maf01_maxmiss07.bed"
snp_readBed(bedfile)
# this will create a .rds file
obj.bigSNP <- snp_attach("genetyped_data_n_514_maf01_maxmiss07.rds")
...
bedfile_noinvers = "genetyped_data_n_514_maf01_maxmiss07_nochr156invers.bed"
snp_readBed(bedfile_noinvers)
# this will create a .rds file
obj.bigSNP_noinvers <- snp_attach("genetyped_data_n_514_maf01_maxmiss07_nochr156invers.rds")
...
# obtain the "bed" snp index during pruning and manually store them into a txt file
G_noinvers <- snp_fastImputeSimple(G, method = c("mean0"), ncores = 8)
