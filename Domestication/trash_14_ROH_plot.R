...
# # HD inds 
# hd_inds <- read_delim("./data/SNP_chip/ramb_mapping/Plates_1-2_HD_QC3_ram.fam", 
#                       " ", col_names = FALSE)[[2]]
...
write_delim(extreme_roh, path = "./extreme_roh.txt")
...
ROH_per_ind
ggsave("figs/roh_per_ind.jpg", ROH_per_ind, width = 7, height = 3, dpi = 300)
