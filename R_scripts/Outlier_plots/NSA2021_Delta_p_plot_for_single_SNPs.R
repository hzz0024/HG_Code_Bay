...
##########  Delta_p plot ###########
####################################
setwd("~/Documents/Ryan_workplace/DelBay19_dxy")
source("manhattan.R")
...
file1 = 'HC_maf0.05_pctind0.7_cv30.mafs' #p1 CH
file0 = 'SR_maf0.05_pctind0.7_cv30.mafs' #p0 REF
dat1 = read.delim(file1, header = TRUE, sep='\t')
dat0 = read.delim(file0, header = TRUE, sep='\t')
p1 = dat1$knownEM #CH
p0 = dat0$knownEM #REF
...
file1 = 'HC_maf0.05_pctind0.7_cv30.mafs' #p1 CH
file0 = 'NB_maf0.05_pctind0.7_cv30.mafs' #p0 REF
dat1 = read.delim(file1, header = TRUE, sep='\t')
dat0 = read.delim(file0, header = TRUE, sep='\t')
p1 = dat1$knownEM #CH
p0 = dat0$knownEM #REF
