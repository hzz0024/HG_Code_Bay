setwd("~/Documents/Ryan_workplace/DelBay_adult/18_Barnard_exact")

# the p-value combiantion code is located at 
# /Users/ryan/Documents/Ryan_workplace/DelBay_adult/19_share_SGS_barnard/pcomb.R
# running script is 
# 
# Rscript pcomb.R --file1 ps_Del19_challenge.txt --file2 barnard_REF19_CHR19.txt --global 'REF19_CHR19_'
# Rscript pcomb.R --file1 ps_Del20_challenge.txt --file2 barnard_REF20_CHR20.txt --global 'REF20_CHR20_'
# Rscript pcomb.R --file1 ps_HC_NB_challenge.txt --file2 barnard_NB_HC.txt --global 'NB_HC_'
# Rscript pcomb.R --file1 ps_HC_SR_challenge.txt --file2 barnard_SR_HC.txt --global 'SR_HC_'
...
ps_adj("barnard_REF19_CHR19.txt", "Del19_ps_outlier.list", "Del19_FDR_outlier.list")
ps_adj("barnard_REF20_CHR20.txt", "Del20_ps_outlier.list", "Del20_FDR_outlier.list")
ps_adj("barnard_SR_HC.txt", "SR_HC_ps_outlier.list", "SR_HC_FDR_outlier.list")
ps_adj("barnard_NB_HC.txt", "NB_HC_ps_outlier.list", "NB_HC_FDR_outlier.list")
...
#######################
# plot distribution
jpeg("B_Del19_FDR_266.jpg", width = 16, height = 9, units = 'in', res = 300)
jpeg("B_shared_396.jpg", width = 16, height = 9, units = 'in', res = 300)
par(mfrow=c(1,2))
