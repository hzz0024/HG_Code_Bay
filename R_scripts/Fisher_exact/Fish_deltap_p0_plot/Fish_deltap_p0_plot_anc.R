...
CH_file = 'CH_maf0.05_pctind0.7_cv30_anc.mafs'
REF_file = 'REF_maf0.05_pctind0.7_cv30_anc.mafs'
HC_file = 'HC_maf0.05_pctind0.7_cv30_anc.mafs'
ARN_file = 'ARN_maf0.05_pctind0.7_cv30_anc.mafs'
COH_file = 'COH_maf0.05_pctind0.7_cv30_anc.mafs'
SR_file = 'SR_maf0.05_pctind0.7_cv30_anc.mafs'
NB_file = 'NB_maf0.05_pctind0.7_cv30_anc.mafs'
...
# save as jpg
ggsave(paste0(pop_name, '_fdr5_anc.jpg'), width = 20, height = 16, units = "cm")
print(sp)
dev.off()
...
# save as jpg
ggsave(paste0(pop_name, '_fdr5_random_sample_anc.jpg'), width = 20, height = 16, units = "cm")
print(sp)
dev.off()
...
# save as jpg
ggsave(paste0(pop_name, '_fdr5_p0_p1_anc.jpg'), width = 20, height = 16, units = "cm")
print(sp)
dev.off()
...
# save as jpg
ggsave(paste0(pop_name, '_fdr5_p0_p1_random_sample_anc.jpg'), width = 20, height = 16, units = "cm")
print(sp)
dev.off()
################################################## Below code is test purpose, useful to check the delta_p pattern

library(ggplot2)
ch_file = 'SR_maf0.05_pctind0.7_cv30_anc.mafs'
ref_file = 'NB_maf0.05_pctind0.7_cv30_anc.mafs'
# obtain the deltap from obs dataset
ch = read.delim(ch_file, header = TRUE, sep = "\t", dec = ".")
ref = read.delim(ref_file, header = TRUE, sep = "\t", dec = ".")
p0 = ref$unknownEM
