...
#------------------------------------------------------------
# result by domajorminor 3 and domaf 1
write_table("fish_CH_REF_HCCOH.txt", "./results/Fish_CH_REF_HCCOH_fdr2.txt" , "./results/Fish_CH_REF_HCCOH_fdr1.txt" , "./results/Fish_CH_REF_HCCOH_fdr5.txt")
write_table("fish_CH_REF_HCNB.txt", "./results/Fish_CH_REF_HCNB_fdr2.txt" , "./results/Fish_CH_REF_HCNB_fdr1.txt" , "./results/Fish_CH_REF_HCNB_fdr5.txt")
write_table("fish_HC_COH.txt", "./results/Fish_HC_COH_fdr2.txt" , "./results/Fish_HC_COH_fdr1.txt" , "./results/Fish_HC_COH_fdr5.txt")
write_table("fish_HC_NB.txt", "./results/Fish_HC_NB_fdr2.txt" , "./results/Fish_HC_NB_fdr1.txt" , "./results/Fish_HC_NB_fdr5.txt")

# result by domajorminor 5 and domaf 2
write_table("fish_CH_REF_HCCOH_anc.txt", "./results/Fish_CH_REF_HCCOH_anc_fdr2.txt" , "./results/Fish_CH_REF_HCCOH_anc_fdr1.txt" , "./results/Fish_CH_REF_HCCOH_anc_fdr5.txt")
write_table("fish_CH_REF_HCNB_anc.txt", "./results/Fish_CH_REF_HCNB_anc_fdr2.txt" , "./results/Fish_CH_REF_HCNB_anc_fdr1.txt" , "./results/Fish_CH_REF_HCNB_anc_fdr5.txt")
write_table("fish_HC_COH_anc.txt", "./results/Fish_HC_COH_anc_fdr2.txt" , "./results/Fish_HC_COH_anc_fdr1.txt" , "./results/Fish_HC_COH_anc_fdr5.txt")
write_table("fish_HC_NB_anc.txt", "./results/Fish_HC_NB_anc_fdr2.txt" , "./results/Fish_HC_NB_anc_fdr1.txt" , "./results/Fish_HC_NB_anc_fdr5.txt")
...
file2 = 'REF_maf0.05_pctind0.7_cv30_anc.mafs'
...
index = index1
diff_list1 = paste(datt1$chromo[index], datt1$position[index], datt1$major[index], datt1$minor[index], datt2$major[index], datt2$minor[index], sep = ' ')
length(diff_list1)
...
index =   !(index1 | index2)
diff_list = paste(datt1$chromo[index], datt1$position[index], datt1$major[index], datt1$minor[index], datt1$anc[index], datt1$knownEM[index], datt2$major[index], datt2$minor[index], datt2$anc[index], datt2$knownEM[index], sep = ' ')
length(diff_list)
