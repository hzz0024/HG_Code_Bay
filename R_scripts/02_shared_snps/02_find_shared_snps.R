...
setwd("~/Dropbox/Mac/Documents/HG/DelBay_all_angsd_final/02_shared_snps")
...
find_shared("All_maf0.05_minmapq30_minq20_pctind0.7_CV30_masked_noinvers.snplist.txt", "Del19_20_1x_share_snps.list")
