...
h1 = as.list(h1)
jpeg("Mahattan_TajimaD_challenge_ch5_5_16552716.jpg", width = 16, height = 9, units = 'in', res = 300)
par(mar=c(7,8,1,6))
par(mfrow=c(1,1))
...
mtext('Tajima\'s D', side=4, line=3, cex=1.2)
# start scaling
lines(xv1, (yv1-low)/(high-low)*(0.5-(-0.5))+(-0.5), xaxt='n',yaxt='n', xlab='', ylab='', col='blue')
#points(xv1,(yv1-low)/(high-low)*(0.5-(-0.5))+(-0.5), col='blue')
lines(xv2, (yv2-low)/(high-low)*(0.5-(-0.5))+(-0.5), xaxt='n',yaxt='n', xlab='', ylab='', col='orange')
#points(xv2,(yv2-low)/(high-low)*(0.5-(-0.5))+(-0.5), col='orange')
...
jpeg("Mahattan_theta_challenge_ch5_5_16552716.jpg", width = 16, height = 9, units = 'in', res = 300)
par(mar=c(7,8,1,6))
par(mfrow=c(1,1))
manhattan(chr="chromo",bp="position",p="deltaP", snp = "SNP", subset(dat1, chromo == 5), xlim = c(16500000, 16600000), highlight2 = h1$V1, logp=FALSE, cex.axis = 1.2, ylim = c(-0.6, 0.6),
          col=c("grey","black"),genomewideline=F, suggestiveline=F,
...
mtext('Nucleotide diversity (pi)', side=4, line=3, cex=1)
...
legend(16585000, -0.45, legend=c("Reference pi", "Survivors pi"), col=c("blue", "orange"), lty=1, cex=0.8)
dev.off()
...
h1 = read.delim(file1, header = FALSE, sep=',')
h1 = as.list(h1)
jpeg("Mahattan_TajimaD_wild_ch5_5_16552716.jpg", width = 16, height = 9, units = 'in', res = 300)
par(mar=c(7,8,1,6))
par(mfrow=c(1,1))
manhattan(chr="chromo",bp="position",p="deltaP", snp = "SNP", subset(dat1, chromo == 5), xlim = c(16500000, 16600000), highlight2 = h1$V1, logp=FALSE, cex.axis = 1.2, ylim = c(-0.6, 0.6),
          col=c("grey","black"),genomewideline=F, suggestiveline=F,
...
legend(16585000, -0.45, legend=c("NB Tajima's D", "HC Tajima's D"), col=c("blue", "orange"), lty=1, cex=0.8)
dev.off()


###################### second plot for deltap and diversity ####################
jpeg("Mahattan_theta_wild_ch5_5_16552716.jpg", width = 16, height = 9, units = 'in', res = 300)
par(mar=c(7,8,1,6))
par(mfrow=c(1,1))
...
legend(16585000, -0.45, legend=c("NB pi", "HC pi"), col=c("blue", "orange"), lty=1, cex=1.2)
